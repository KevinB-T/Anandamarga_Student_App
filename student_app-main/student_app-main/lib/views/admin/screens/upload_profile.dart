    ...
    try {
      ...
      if (pickedImage != null) {
        final croppedImage = await imageCropper.cropImage(
          ...
          aspectRatioPresets: [CropAspectRatioPreset.square], // Optional
          compressQuality: 75, // Optional: Set compression quality (0-100)
          maxHeight: 512, // Optional
          maxWidth: 512, // Optional
        );
        ...
        if (croppedImage != null) {
          ...
          // Handle scenario where cropping is cancelled by user
